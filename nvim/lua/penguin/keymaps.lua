...
set('i', '<C-a>', '<Home>', opts)
set('i', '<C-e>', '<End>', opts)
set('i', '<M-Right>', '<C-o>w', opts)
set('i', '<M-f>', '<C-o>w', opts)
set('i', '<M-Left>', '<C-o>b', opts)
set('i', '<M-b>', '<C-o>b', opts)
set('i', '<M-BS>', '<C-o>db', opts)
set('i', '<M-DEL>', '<C-o>dw', opts)
set('i', '<M-d>', '<C-o>dw', opts)
